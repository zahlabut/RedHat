...
if 'ciross' not in existing_images:
    ...
    print (exec_command_line_command(install_wget)['CommandOutput'])
    download_cirros='wget -4 http://download.cirros-cloud.net/0.3.5/cirros-0.3.5-x86_64-disk.img'
    print (exec_command_line_command(download_cirros)['CommandOutput'])
    print (exec_command_line_command('openstack image create --disk-format qcow2 --file cirros-0.3.5-x86_64-disk.img --public cirros')['CommandOutput'])
    print (exec_command_line_command('openstack image create --disk-format qcow2 --file rhel-guest-image-7.2-20151102.0.x86_64.qcow2 --public rhel')['CommandOutput'])
